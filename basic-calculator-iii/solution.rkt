...
(module+ test
  (require rackunit)
  (check-equal? (calculate "1+1") 2)
  (check-equal? (calculate "6-4/2") 4)
  (check-equal? (calculate "14-3/2") 13)
  (check-equal? (calculate "2*(5+5*2)+3*5") 45)
  (check-equal? (calculate "(0-3)/2") -1))   ;; truncation toward zero
